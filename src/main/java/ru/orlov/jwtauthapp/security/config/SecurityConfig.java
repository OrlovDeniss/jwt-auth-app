package ru.orlov.jwtauthapp.security.config;
...
import ru.orlov.jwtauthapp.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userSecDetailsService);
